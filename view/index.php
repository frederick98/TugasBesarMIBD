            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12 d-flex align-items-center justify-content-between">
                        <!-- Logo Area -->
                        <div class="logo">
                            <a href="index.php"><img src="lib/user/img/core-img/Ramenku.jpg" alt=""></a>
                        </div>
                        ...
                        <div class="search-login-area d-flex align-items-center">
                            ...
                            <div class="login-area">
                                <a href="User/login.php"><span>Login / Register</span> <i class="fa fa-lock" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="User/ramen-review.php">Ramen</a></li>
                                    <li><a href="User/restaurant-review.php">Restaurant</a></li>
                                    <li><a href="User/reviewer.php">Our Reviewer</a></li>
                                    <li><a href="User/make-review.php">Make Your own Review</a></li>
