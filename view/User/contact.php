...
<body>
   ...
   <header class="header-area wow fadeInDown" data-wow-delay="500ms">
    ...
    <section class="breadcrumb-area bg-img bg-overlay" style="background-image: url(../lib/user/img/bg-img/contact-us.jpg);">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <!-- Breadcrumb Text -->
                <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-4">
                            <div class="contact-content mb-100">
                                <a href="#" class="mb-50 d-block"><img src="../lib/user/img/core-img/Ramenku.jpg" alt=""></a>
                                <p>If you have any problem from input review or error from our website, you can contact us for our customer services</p>
                            </div>
                        </div>
                        <div class="col-12 col-lg-4">
                            <div class="contact-content mb-100">
                                <p>Our customer services is avialable for 24 hours, so if you have any trouble you can contact us</p>
                            </div>
                        </div>
                        <div class="col-12 col-lg-4">
                            <div class="contact-content mb-100">
